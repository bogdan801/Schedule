...
public class TimeScheduleFragment extends Fragment {
    ...
    private TextView[][] timeCells = new TextView[2][7];
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        timeCells[0][0] = (TextView) view.findViewById(R.id.startTimeCell1);
        timeCells[0][1] = (TextView) view.findViewById(R.id.startTimeCell2);
        timeCells[0][2] = (TextView) view.findViewById(R.id.startTimeCell3);
        timeCells[0][3] = (TextView) view.findViewById(R.id.startTimeCell4);
        timeCells[0][4] = (TextView) view.findViewById(R.id.startTimeCell5);
        timeCells[0][5] = (TextView) view.findViewById(R.id.startTimeCell6);
        timeCells[0][6] = (TextView) view.findViewById(R.id.startTimeCell7);

        timeCells[1][0] = (TextView) view.findViewById(R.id.endTimeCell1);
        timeCells[1][1] = (TextView) view.findViewById(R.id.endTimeCell2);
        timeCells[1][2] = (TextView) view.findViewById(R.id.endTimeCell3);
        timeCells[1][3] = (TextView) view.findViewById(R.id.endTimeCell4);
        timeCells[1][4] = (TextView) view.findViewById(R.id.endTimeCell5);
        timeCells[1][5] = (TextView) view.findViewById(R.id.endTimeCell6);
        timeCells[1][6] = (TextView) view.findViewById(R.id.endTimeCell7);
